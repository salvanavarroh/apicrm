    ...
    <div className="flex flex-col gap-6">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Creá formularios embebibles para capturar leads desde campañas o tu
            sitio. Cada submission entra como lead nuevo.
          </p>
        </div>
        <Button asChild>
      ...
      {rows.length === 0 ? (
        <Card className="flex flex-col items-center justify-center gap-3 px-6 py-16 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Todavía no hay formularios. Creá el primero y compartí el link.
          </p>
          <Button asChild>
            <Link href="/admin/forms/new">Crear primer formulario</Link>
          </Button>
        </Card>
      ) : (
